...
export enum FeatureFlags {
  ...
  CONTENT_LIST_UPDATES_ENABLED = 'content list_updates_enabled',
  ...
  SURFACE_LIVE_ENABLED = 'surface_live_enabled',
  ...
  CONTENT_LIST_FOLDERS = 'content list_folders',
...
export const flagDefaults: { [key in FeatureFlags]: boolean } = {
  ...
  [FeatureFlags.SOL_WALLET_LIVE_ENABLED]: false,
  [FeatureFlags.SURFACE_LIVE_ENABLED]: false,
  [FeatureFlags.PREFER_HIGHER_PATCH_FOR_PRIMARY]: true,
  [FeatureFlags.PREFER_HIGHER_PATCH_FOR_SECONDARIES]: true,
  [FeatureFlags.ENABLE_SPL_LIVE]: false,
...
export const flagCohortType: {
  ...
  [FeatureFlags.SOL_WALLET_LIVE_ENABLED]: FeatureFlagCohortType.USER_ID,
  [FeatureFlags.SURFACE_LIVE_ENABLED]: FeatureFlagCohortType.USER_ID,
  ...
  [FeatureFlags.PREFER_HIGHER_PATCH_FOR_SECONDARIES]:
    FeatureFlagCohortType.SESSION_ID,
  [FeatureFlags.ENABLE_SPL_LIVE]: FeatureFlagCohortType.SESSION_ID,
