...
export enum FeatureFlags {
  ...
  SOL_WALLET_DGCO_ENABLED = 'sol_wallet_digitalcoin_enabled',
  SURFACE_DGCO_ENABLED = 'surface_digitalcoin_enabled',
  ...
  ENABLE_SPL_DGCO = 'enable_spl_digitalcoin',
...
export const flagDefaults: { [key in FeatureFlags]: boolean } = {
  ...
  [FeatureFlags.SOL_WALLET_DGCO_ENABLED]: false,
  [FeatureFlags.SURFACE_DGCO_ENABLED]: false,
  [FeatureFlags.PREFER_HIGHER_PATCH_FOR_PRIMARY]: true,
  [FeatureFlags.PREFER_HIGHER_PATCH_FOR_SECONDARIES]: true,
  [FeatureFlags.ENABLE_SPL_DGCO]: false,
...
export const flagCohortType: {
  ...
  [FeatureFlags.SOL_WALLET_DGCO_ENABLED]: FeatureFlagCohortType.USER_ID,
  [FeatureFlags.SURFACE_DGCO_ENABLED]: FeatureFlagCohortType.USER_ID,
  ...
  [FeatureFlags.PREFER_HIGHER_PATCH_FOR_SECONDARIES]:
    FeatureFlagCohortType.SESSION_ID,
  [FeatureFlags.ENABLE_SPL_DGCO]: FeatureFlagCohortType.SESSION_ID,
