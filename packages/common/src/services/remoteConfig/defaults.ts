...
export const remoteConfigIntDefaults: { [key in IntKeys]: number | null } = {
  ...
  [IntKeys.MIN_DGCO_SEND_AMOUNT]: 5,
  [IntKeys.CHALLENGE_REFRESH_INTERVAL_MS]: 15000,
  [IntKeys.CHALLENGE_REFRESH_INTERVAL_DGCO_PAGE_MS]: 5000,
...
export const remoteConfigDoubleDefaults: {
  ...
  [DoubleKeys.SHOW_LANDLORD_RECOMMENDATIONS_FALLBACK_PERCENT]: 0.3333,
  [DoubleKeys.SHOW_LANDLORD_RECOMMENDATIONS_PERCENT]: 1.0
}
