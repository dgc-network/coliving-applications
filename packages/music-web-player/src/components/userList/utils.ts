...
export type UserListProviderArgs<T, U = void> = {
  // Gets the digital_content or contentList we're referencing.
  ...
  // e.g. followee reposts on a digital_content
  extractUserIDSubsetFromEntity: (entity: T) => ID[]

  // Fetch all the relevant users for the entity.
  // e.g. all users who've reposted a digital_content.
...
// when you follow a pattern of pulling a subset of users out of an entity (digital_content/collection)
// that should be on the top of the list, and then combining it with all users.
//
// e.g. sort followee_reposts on the top of the digital_content repost list.
//
