...
export class ClientRewardsReporter {
  ...
  reportSuccess({
    ...
    ;(async () => {
      try {
        await digital_content(Name.REWARDS_CLAIM_SUCCESS, {
          userId,
          challengeId,
          amount,
          specifier,
  ...
  reportRetry({
    ...
    ;(async () => {
      try {
        await digital_content(Name.REWARDS_CLAIM_RETRY, {
          userId,
          challengeId,
          amount,
          specifier,
  ...
  reportFailure({
    ...
    ;(async () => {
      try {
        await digital_content(Name.REWARDS_CLAIM_FAILURE, {
          userId,
          challengeId,
          amount,
          specifier,
