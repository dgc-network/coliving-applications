 ...
 *  1. Create contentList
 *  2. Change contentList name
 *  3. Change contentList description
 ...
 *
 * @param uid (string) A unique identifier for this confirmation (e.g. digital_content id)
...
/** Enqueues a confirmation call to make, e.g. "create contentList with a temp id, wait for contentList to appear in discovery node"." */
...
/**
 * Sets the result of a confirmation call, e.g. "save the discprov's returned contentList id"
