...
import { RequestNetworkConnected } from 'services/nativeMobileInterface/lifecycle'
 ...
 *  yield call(ColivingBackend.doSomething, param)
 * }
 */
...
export function* setupBackend() {
  ...
  const { web3Error, libsError } = yield call(ColivingBackend.setup)
  if (libsError) {
