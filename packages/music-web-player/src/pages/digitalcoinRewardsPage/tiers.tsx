...
import { pressDiscord } from 'common/store/pages/tokenDashboard/slice'
import { badgeTiers, getTierNumber } from 'common/store/wallet/utils'
import { show } from 'components/musicConfetti/store/slice'
import { BadgeTierText } from 'components/userBadges/profilePageBadge'
...
const messages = {
  title: '$DGC VIP TIERS',
  subtitle1: `Unlock $DGC VIP Tiers by simply holding more $DGC!`,
  ...
  tierLevel: (amount: string) => `${Number(amount).toLocaleString()}+ $DGC`,
...
/** Renders out level of digitalcoin required for a tier - e.g. '1000+ $DGC */
