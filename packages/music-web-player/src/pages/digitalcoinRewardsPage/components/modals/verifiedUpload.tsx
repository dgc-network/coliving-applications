...
const messages = {
  ...
  step2Title: 'Step 2: Upload a DigitalContent',
  step2SubtitleDesktop: 'Upload your first digital_content from your verified account',
  step2SubtitleMobile: 'Upload your first digital_content from your computer',
  uploadButton: 'Upload',
  step3Title: 'Step 3: Tag us And Let Us Know',
  step3Subtitle:
    'Post a link to your digital_content from your verified Twittter or Instagram and tag us',
