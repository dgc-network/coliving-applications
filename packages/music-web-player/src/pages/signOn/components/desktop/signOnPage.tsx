...
import { ID, Status, User } from '@coliving/common'
...
import SignOnModal from 'components/signOn/signOnModal'
import Toast from 'components/toast/toast'
import { ComponentPlacement, MountPlacement } from 'components/types'
import LoadingPage from 'pages/signOn/components/loadingPage'
import { EmailPage } from 'pages/signOn/components/desktop/emailPage'
import FollowPage from 'pages/signOn/components/desktop/followPage'
import PasswordPage from 'pages/signOn/components/desktop/passwordPage'
import ProfilePage from 'pages/signOn/components/desktop/profilePage'
import { SignInPage } from 'pages/signOn/components/desktop/signInPage'
import StartPlatformPage from 'pages/signOn/components/desktop/startPlatformPage'
import { getStatus } from 'pages/signOn/store/selectors'
...
const SignOnProvider = ({
  ...
  const pages = {
    ...
    [Pages.START]: (style: object) => (
      ...
      >
        <StartPlatformPage
          onUploadDigitalContent={onUploadDigitalContent}
