...
const messages = {
  ...
  features:
    'Build a fanbase, share your works in progress, and then publish your completed digitalContents for all the world to hear. Create, grow, and monetize, all without the need to graduate off the platform or sign a record deal.'
}
