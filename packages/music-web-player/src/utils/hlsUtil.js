...
const STREAM_VARIANT_65K = `#EXT-X-STREAM-INF:TYPE=LIVE,BANDWIDTH=65000,CODECS="mp4a.40.2"`
...
export const generateM3U8 = (
  ...
  // Special case digitalContents that were segmented incorrectly and only have one segment
