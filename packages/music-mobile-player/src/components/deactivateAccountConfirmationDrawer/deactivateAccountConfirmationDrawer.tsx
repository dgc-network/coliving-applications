...
const messages = {
  ...
  doubleCheckText:
    'There is no going back. This will remove all of your digitalContents, albums, and contentLists. You will not be able to re-register with the same email or handle',
