...
import IconFavoriteOffLight from 'app/assets/animations/iconFavoriteDigitalContentTileOffLight.json'
import IconFavoriteOnLight from 'app/assets/animations/iconFavoriteDigitalContentTileOnLight.json'
