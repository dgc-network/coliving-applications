...
import { CopyTextTile } from 'app/components/copyTextTile'
...
const messages = {
  ...
  body: 'To access the private token-holders only Discord channel and/or update your Discord role, send a DM to the Coliving VIP Discord Bot (@$LIVE-BOT) with this code',
