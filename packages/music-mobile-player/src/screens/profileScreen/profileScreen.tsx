...
import { fetchProfile } from '@coliving/web/src/common/store/pages/profile/actions'
import { getProfileStatus } from '@coliving/web/src/common/store/pages/profile/selectors'
...
import { TopBarIconButton } from 'app/screens/appScreen'
