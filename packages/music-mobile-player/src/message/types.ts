...
export enum MessageType {
  ...
  FETCH_ALL_FOLLOW_LANDLORDS = 'fetch_all_follow_landlords',
  FETCH_ALL_FOLLOW_LANDLORDS_SUCCEEDED = 'fetch_all_follow_landlords_succeeded',
  FETCH_ALL_FOLLOW_LANDLORDS_FAILED = 'fetch_all_follow_landlords_failed',
  SET_FOLLOW_LANDLORDS = 'set_follow_landlords',
