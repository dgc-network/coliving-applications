...
import type { RemoteConfigState } from '@coliving/web/src/common/store/remote-config/slice'
import remoteConfig from '@coliving/web/src/common/store/remote-config/slice'
import { createStore, combineReducers, applyMiddleware } from 'redux'
import { composeWithDevTools } from 'redux-devtools-extension'
import createSagaMiddleware from 'redux-saga'

import type { AudioState } from './digitalcoin/reducer'
import digitalcoin from './digitalcoin/reducer'
