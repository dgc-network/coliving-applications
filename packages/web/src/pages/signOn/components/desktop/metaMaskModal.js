...
const messages = {
  ...
  body1:
    'Creating an Coliving account with MetaMask will negatively impact your Coliving experience in a significant way. We strongly suggest creating your account with an email and password.',
  body2:
