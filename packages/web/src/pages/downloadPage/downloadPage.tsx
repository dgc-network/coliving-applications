...
import CTASignUp from 'pages/landingPage/components/ctaSignUp'
...
const messages = {
  downloadTitle: 'Download the Coliving App',
  downloadSubtitle:
    'Looking for the best experience? Check out the Coliving App ',
  getMobileApp: 'Get the mobile app',
  getDesktopApp: 'Get the desktop app',
  getDesktopAppSubtitle: 'The definitive Coliving Experience',
