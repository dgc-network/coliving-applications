...
const messages = {
  ...
  subTitle:
    'The Coliving community is full of up-and-coming DJs & producers looking to give back to the music scene'
}
...
const cards = [
  {
    ...
    description:
      'Take part in the hottest new remix competitions on Coliving and dive in to explore the best our community has to offer.',
    image: imgRemix,
    backgroundGradient:
