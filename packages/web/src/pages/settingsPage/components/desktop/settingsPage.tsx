...
const messages = {
  ...
  getVerified: 'Get verified by linking a verified social account to Coliving',
  matrixMode: '🕳 🐇 Matrix',
  changePassword: 'Change Password',
  changePasswordDescription: 'Change the password to your Coliving account'
}
        ...
        <div className={styles.settings}>
          ...
          {!isMobile() && !isElectron() && (
            <SettingsCard
              ...
              description='For the best experience, we recommend downloading the Coliving Desktop App'
            >
              <Button
