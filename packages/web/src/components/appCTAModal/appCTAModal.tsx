...
import { Modal, Button, IconDownload, ButtonType } from '@coliving/stems'
...
const messages = {
  ...
  desktop: 'Download The Coliving Desktop App',
  dividerWord: 'and',
...
/**
 * Modal that presents a CTA to download the Coliving apps.
 */
const AppCTAModal = () => {
