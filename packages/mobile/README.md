# Coliving Mobile Client

The Coliving React Native mobile client.

This project is a React Native wrapper around the Coliving web client, and requires a web client to be running.
...
This URL should be a serving a mobile -client with either
