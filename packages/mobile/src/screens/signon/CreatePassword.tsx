...
const messages = {
  ...
  termsAndPrivacy:
    'By clicking continue, you state you have read and agree to Coliving',
  terms: 'Terms of Use',
  and: 'and',
...
const CreatePassword = ({ navigation, route }: CreatePasswordProps) => {
  ...
  const onTermsOfUse = () => {
    Linking.openURL('https://.co/legal/terms-of-use').catch((err) =>
      console.error('An error occurred trying to open terms of use', err)
    )
  }

  const onPrivacyPolicy = () => {
    Linking.openURL('https://.co/legal/privacy-policy').catch((err) =>
