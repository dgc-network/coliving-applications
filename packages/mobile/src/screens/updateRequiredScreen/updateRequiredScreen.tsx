...
const ANDROID_PLAY_STORE_LINK =
  'https://play.google.com/store/apps/details?id=co..app'
const IOS_APP_STORE_LINK = 'itms-apps://us/app/-music/id1491270519'

const messages = {
  header: 'Please Update ✨',
  text: "The version of Coliving you're running is too far behind.",
